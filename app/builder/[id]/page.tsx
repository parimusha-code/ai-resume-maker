  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        {/* Reuse the form structure from builder/page.tsx here */}
        {/* For brevity, I'm including a simplified version or I could copy the whole thing */}
        {/* I will copy the whole thing to ensure consistency */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           {/* Form content same as builder/page.tsx ... */}
           {/* I'll use the full form code below */}
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 p-8">
