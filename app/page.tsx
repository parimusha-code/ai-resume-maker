...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-500">
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-3xl overflow-hidden border border-slate-100 relative">
        {/* Navigation / Builder Link Overlay */}
        <div className="absolute top-6 right-6 z-20">
          <Link href="/builder" className="px-4 py-2 bg-slate-900/5 hover:bg-slate-900/10 text-slate-600 text-xs font-bold rounded-full transition-all border border-slate-200">
            Open Builder →
          </Link>
        </div>

        {/* Top Accent Bar */}
        <div className="h-3 bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 text-transparent select-none">.</div>
        ...
        <div className="p-8 sm:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <section>
                ...
                <p className="text-lg font-medium leading-relaxed text-slate-600 italic border-l-4 border-indigo-100 pl-6 py-2">
                  "{resumeData.summary}"
                </p>
              </section>
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-2">
                  {resumeData.skills.map((skill, i) => (
                    <span key={i} className="px-3 py-1 bg-white border border-slate-200 text-slate-700 text-[10px] font-bold rounded-full shadow-sm hover:border-indigo-400 hover:text-indigo-600 cursor-default transition-all uppercase tracking-tight">
                      {skill}
                    </span>
                  ))}
                </div>
          ...
          {/* Footer Action */}
          <footer className="mt-16 pt-10 border-t border-slate-100 flex flex-col items-center gap-6">
            ...
            <p className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em] text-center">
